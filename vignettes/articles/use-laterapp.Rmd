...
various formats, in addition to the raw data that was used to generate such 
figure.
*	**Save/restore session** can be used to save the state of the app at any point 
in time, which will download a file to your local computer. This file can later 
...
the fit you wish to visalise and customise. Options include:
