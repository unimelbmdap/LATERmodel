...
In this example, the 'swivel' fit is the preferred fit (also indicated in the `preferred` column) as the 'shift' fit has an AIC that is 344.905 units lower than the AIC for the 'swivel' fit.
